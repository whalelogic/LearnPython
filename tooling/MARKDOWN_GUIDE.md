...
- This repository relies heavily on topic-level README files, so Markdown is not just a writing skill here—it is part of how learners navigate the material.
- Try improving one README after reading this guide: add a short overview, one runnable example, and a few next steps for the reader.
- Consistent headings, code fences, and link paths matter because they keep the learning flow predictable across folders.
