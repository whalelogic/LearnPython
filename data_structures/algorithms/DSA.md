...
- Use this reference after [../Data_Structures.md](../Data_Structures.md) so the data structure trade-offs feel concrete before you jump into algorithm patterns.
- A good way to study this file is to pick one algorithm and implement it twice: first clearly, then with attention to time and space complexity.
- Many interview-style problems become easier when you first ask whether a list, set, dictionary, deque, or heap gives you the operations you need cheaply.
